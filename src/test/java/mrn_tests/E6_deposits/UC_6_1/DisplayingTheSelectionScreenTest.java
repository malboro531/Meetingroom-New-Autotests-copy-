...
public class DisplayingTheSelectionScreenTest extends BaseDepositTest {

    @TestRails(id = "c6019033")
    @Test(description = "The 'Selection' screen opened", groups = {"GUI"})
    public void c6019033() {
        goToDepositsScreen();
