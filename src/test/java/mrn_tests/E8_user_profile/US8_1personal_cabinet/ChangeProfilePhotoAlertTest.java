...
public class ChangeProfilePhotoAlertTest extends BaseTest {

    @TestRails(id = "C6067094")
    @Test(description = "Check the alert while changing profile photo", groups = {"Functional"})
    public void C6067094() {
        loginUser();
